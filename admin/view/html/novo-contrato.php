         ...
         <div class="row dados-produtos">
            <div class="col-md-4 mb-6">
               ...
               <select multiple='multiple' class="form-control produtoContrato" id="listaproduto" name="produto[]">
                  ...
                  <?php while($inscricao = $rows->fetch(PDO::FETCH_OBJ)): ?>
                  <option value="<?php echo $inscricao->idProduto ?>"><?php echo $inscricao->nomeProduto ?></option>
                  <?php endwhile; ?>
               </select>
            </div>
         ...
         <div class="row">
            <div class="col-md-3 mb-3">
               ...
               <div class="input-group">
                  ...
                  <input type="text" class="form-control total money" id="total" name="total" required>
