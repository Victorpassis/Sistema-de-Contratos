      ...
      <div class="card-body">
         <div class="row">
            ...
            <div class="col-md-4 mb-3">
               ...
               <input type="text" class="form-control" id="usuario" name="usuario" value="<?php echo $rows->usuario; ?>" required>
            </div>
            <div class="col-md-4 mb-3">
               ...
               <div class="input-group">
                  ...
                  <input type="text" id="cpf-cnpf" class="form-control cnpj-cpf cpf" name="cpf-cnpf" value="<?php echo $rows->dados; ?>" required>
               </div>
            </div>
         </div>
         <div class="row">
