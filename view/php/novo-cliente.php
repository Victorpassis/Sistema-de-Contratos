   ...
   //function __construct() {
      ...
      switch ($_POST["function"]) {
         case 'cadastrarCliente':
            echo $clienteCtrl->cadastraCliente($nome, $dado, $cidade, $cep, $estado, $endereco, $numero, $bairro);
            break;
         case 'editarCliente':
            echo $clienteCtrl->editarCliente($nome, $dado, $cidade, $cep, $estado, $endereco, $numero, $bairro, $_POST["idCliente"]);
            break;
         case 'excluirCliente':
